...
def generate_launch_description() -> LaunchDescription:
    ...
    sim_dir = get_package_share_directory('amr_sim')
    ...
    declare_map_yaml_cmd = DeclareLaunchArgument(
        'map',
        default_value=os.path.join(bringup_dir, 'data', 'maps', 'samhyun_map.yaml'),
    )
    ...
    declare_robot_sdf_cmd = DeclareLaunchArgument(
        'robot_sdf',
        default_value=os.path.join(sim_dir, 'description', 'urdf', 'testbot.urdf.xacro'),
        description='Full path to robot sdf file to spawn the robot in gazebo',
    )

    urdf = os.path.join(sim_dir, 'description', 'urdf', 'testbot.urdf.xacro')
    ...
    bringup_cmd = IncludeLaunchDescription(
        PythonLaunchDescriptionSource(os.path.join(launch_dir, 'amr_nav_bringup_launch.py')),
        launch_arguments={
            'namespace': namespace,
            'slam': slam,
            'map': map_yaml_file,
