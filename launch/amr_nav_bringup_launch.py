...
def generate_launch_description():
    ...
    declare_map_yaml_cmd = DeclareLaunchArgument(
        'map', default_value=os.path.join(bringup_dir,'data', 'maps', 'skku_7th.yaml'),
    ...
    bringup_cmd_group = GroupAction(
        [
            ...
            IncludeLaunchDescription(
                ...
                condition=IfCondition(PythonExpression(["'", slam, "' == 'True' and ('", use_localization, "' == 'true' or '", use_localization, "' == 'True')"])),
                launch_arguments={
                    'namespace': namespace,
